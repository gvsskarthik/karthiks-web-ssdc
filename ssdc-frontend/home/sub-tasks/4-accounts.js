...
function setSummaryMessage(message){
  sumRevenue.innerHTML =
    `<h4>Total Revenue</h4><p style="sumDiscount.innerHTML =
    `<h4>Discounts Given</h4><p style="
  sumCommission.innerHTML =
    `<h4>Total Commission</h4><p style="sumProfit.innerHTML =
    `<h4>Net Profit</h4><p style="
}
